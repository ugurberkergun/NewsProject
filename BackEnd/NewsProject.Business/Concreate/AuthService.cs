...
namespace NewsProject.Business.Concreate
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IUserService userService, ITokenHelper tokenHelper, IUserOperationClaimService userOperationClaimService)
        {
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto, string password)
        {
            ...
            var user = new User
            {
                ...
                Status = true  // örneğin mail ile doğrulama veya manuel izin verme yapılabilir.Biz burada direk true verdik.
            };
            _userService.Add(user);
            var userInfo = _userService.GetByEmail(userForRegisterDto.Email);
